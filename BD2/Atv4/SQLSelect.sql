...
Select Count(Cod_Envio) from Envio where Regiao not like null;
...
Select * from Envio where DataEnvio = '08/08/1996';
Select * from Envio where datepart(month from DataEnvio ) >= 11;
